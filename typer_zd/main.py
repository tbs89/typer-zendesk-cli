...
from post import *
from put import *
from advanced import run_macro_on_tickets, apply_tags_to_tickets
...
def get_data_actions():
    while True:
        print("\n[bold blue]Select the data you want to download:[/bold blue]")
        typer.echo("---------------------------------------")
        ...
        if choice != 13:
            environment = typer.prompt("Is this for production or sandbox?", type=str)
...
def post_data_actions():
    while True:
        ...
        if choice == 1:
            ...
            print(
                "[Download CSV Template: https://github.com/tbs89/typer_zd/blob/main/docs/templates/create_agents_template.csv]")
            file_name = typer.prompt("3 - Enter the name of the CSV file you've uploaded (including .csv)")
...
def admin_actions():
    while True:
        ...
        typer.echo("-------------------------------------------------")
        typer.echo("[5] Not sure what you need?")
...
def put_data_actions():
    while True:
        ...
        if choice == 1:
            ...
            print(
                  "[Download CSV Template: https://github.com/tbs89/typer_zd/blob/main/docs/templates/macro_update_template.csv]")
...
def advanced_data_actions():
    while True:
        ...
        if choice == 1:
            ...
            print("[Download CSV Template: https://github.com/tbs89/typer_zd/blob/main/docs/templates/apply_macro_template.csv4]")
            typer.echo(
            ...
            print(
                "[Download CSV Template: https://github.com/tbs89/typer_zd/blob/main/docs/templates/apply_tags_template.csv]")
